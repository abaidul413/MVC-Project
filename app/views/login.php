...
.loginsection{width: 350px; margin: 50px auto; border: 1px solid #ddd; border-radius: 5px; box-shadow: 5px 5px 5px #999; padding:20px;}
...
<h1>Login</h1>
  ...
  <div class="loginsection">
  	 <form action="" method="">
  	 	<table>
  	 		...
  	 		<tr>
  	 			<td>Password:</td>
  	 			<td><input type="password" name="username" placeholder="Password..." /></td>
  	 		</tr>
  ...
  <footer class="footeroption">
	  ...
	  <p>Md. Abaidul Haque</p>
	  <p>Software Engineer At Vivacom,</p>
	  <p>PHP Programmer</p>
