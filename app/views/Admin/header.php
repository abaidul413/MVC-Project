...
.widget h3 {margin: 0px;background: #3399FF;color: #000;text-shadow: 0 1px 1px #fff;border-bottom: 1px solid #066cd2;margin: 0 0 2px;padding: 5px; }

.widget ul{margin:0px; padding:0px; list-style: none;}
.widget ul li{display: block; }
.widget ul li a {text-decoration: none;background: #ddd;color: #000;display: block;border-bottom: 1px solid #fff;padding: 5px 10px;
}
.widget ul li a:hover{background: #b1b1b1;}

.adminritht{width:572px; float: right; padding:5px 10px; background: #fafafa;}
.adminritht h2 {margin: 0px;margin-bottom: 10px;border-bottom: 2px dashed #666;padding-bottom: 10px;color: #666;}
